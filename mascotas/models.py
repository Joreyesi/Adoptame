...
class Organizacion(models.Model):
    ...
    usuario = models.ForeignKey('mascotas.Usuario', related_name='mascotas', on_delete=models.CASCADE)  # Asegúrate de reemplazar 'TuApp' con el nombre real de tu aplicación.
...
class Estado(models.Model):
    ...
    id_mascota = models.ForeignKey('mascotas.Mascota', related_name='mascotas', on_delete=models.CASCADE)  # Asegúrate de reemplazar 'TuApp' con el nombre real de tu aplicación.
...
class Publicacion(models.Model):
    ...
    id_org_o = models.ForeignKey('mascotas.Organizacion', related_name='mascotas', on_delete=models.CASCADE)  # Asegúrate de reemplazar 'TuApp' con el nombre real de tu aplicación.
...
class Comuna(models.Model):
    ...
    nombre_r = models.ForeignKey('mascotas.Region', related_name='mascotas', on_delete=models.CASCADE)  # Asegúrate de reemplazar 'TuApp' con el nombre real de tu aplicación.
    ...
    id_org_o = models.ForeignKey('mascotas.Organizacion', related_name='mascotas', on_delete=models.CASCADE, blank=True, null=True)  # Asegúrate de reemplazar 'TuApp' con el nombre real de tu aplicación.
