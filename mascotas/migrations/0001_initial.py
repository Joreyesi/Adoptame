# Generated by Django 4.2.6 on 2023-12-27 20:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_u', models.CharField(blank=True, max_length=20, null=True, unique=True)),
                ('contraseña_u', models.CharField(max_length=128)),
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='usuarios_related_groups', to='auth.group')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='usuarios_related_permissions', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, help_text='Designates whether this user should be treated as active. Unselect this instead of deleting accounts.', verbose_name='active')),
                ('date_joined', models.DateTimeField(default=django.utils.timezone.now, verbose_name='date joined')),
                ('rut_superusuario', models.CharField(max_length=12, primary_key=True, serialize=False)),
                ...
                ('id_su', models.CharField(blank=True, max_length=20, null=True, unique=True)),
                ('contraseña_su', models.CharField(max_length=128)),
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='superusuarios_related_groups', to='auth.group')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='superusuarios_related_permissions', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
